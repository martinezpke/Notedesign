...
const ModalCreate = ({ onClick, data, isOpen }) => {
  ...
  const addDataVariable = async () =>  {
    await data(valueTitle, valueDescription)
  }
    ...
    <>
      <div className="modal-overlay" onFocus={handleAutoHight}>
        ...
        <div className="modal-footer">
          ...
          <button className="modal-close-btn" onClick={onClick}>Crear</button>
        </div>
      </div>
    </>
  )
